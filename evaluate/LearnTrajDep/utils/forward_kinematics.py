...
def _some_variables_hdm05():
    ...
    offset = 70 * np.array(
        [0, 0, 0,
         1.65674000000000, -1.80282000000000, 0.624770000000000,
         2.59720000000000, -7.13576000000000, 0,
         2.49236000000000, -6.84770000000000, 0,
         # 0.197040000000000, -0.541360000000000, 2.14581000000000,
         # 0, 0, 1.11249000000000,
         # 0, 0, 0,
         -1.61070000000000, -1.80282000000000, 0.624760000000000,
         -2.59502000000000, -7.12977000000000, 0,
         -2.46780000000000, -6.78024000000000, 0,
         # -0.230240000000000, -0.632580000000000, 2.13368000000000,
         # 0, 0, 1.11569000000000,
         # 0, 0, 0,
         0.0196100000000000, 2.05450000000000, -0.141120000000000,
         0.0102100000000000, 2.06436000000000, -0.0592100000000000,
         # 0, 0, 0,
         0.00713000000000000, 1.56711000000000, 0.149680000000000,
         # 0.0342900000000000, 1.56041000000000, -0.100060000000000,
         # 0.0130500000000000, 1.62560000000000, -0.0526500000000000,
         # 0, 0, 0,
         3.54205000000000, 0.904360000000000, -0.173640000000000,
         4.86513000000000, 0, 0,
         3.35554000000000, 0, 0,
         # 0, 0, 0,
         # 0.661170000000000, 0, 0,
         # 0.533060000000000, 0, 0,
         # 0, 0, 0,
         # 0.541200000000000, 0, 0.541200000000000,
         # 0, 0, 0,
         -3.49802000000000, 0.759940000000000, -0.326160000000000,
         -5.02649000000000, 0, 0,
         -3.36431000000000, 0, 0,
         # 0, 0, 0,
         # -0.730410000000000, 0, 0,
         # -0.588870000000000, 0, 0,
         # 0, 0, 0,
    ...
    expmapInd = np.split(np.arange(4, 52) - 1, 16)
