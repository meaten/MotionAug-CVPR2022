...
import learning.nets.fc_4layers_1024units as fc_4layers_1024units
...
def build_net(net_name, input_tfs, reuse=False):
    ...
    elif (net_name == fc_3layers_1024units.NAME):
        net = fc_3layers_1024units.build_net(input_tfs, reuse)
    elif (net_name == fc_4layers_1024units.NAME):
        net = fc_4layers_1024units.build_net(input_tfs, reuse)
    else:
