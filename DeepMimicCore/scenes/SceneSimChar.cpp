...
void cSceneSimChar::ParseArgs(const std::shared_ptr<cArgParser>& parser)
{
	...
	parser->ParseDouble("min_perturb_duration", mPerturbParams.mMinDuration);
...
bool cSceneSimChar::BuildController(const cCtrlBuilder::tCtrlParams& ctrl_params, std::shared_ptr<cCtController>& out_ctrl)
{
...
void cSceneSimChar::ResetRandPerturb()
{
