...
public:
	...
	static void Drawoctosphere(double d, double h, double y, eDrawMode draw_mode);
...
protected:
	...
	static std::unique_ptr<cDrawMesh> gOctoSphereMesh;
	static std::unique_ptr<cDrawMesh> gSphereWireSimpleMesh;
	static std::unique_ptr<cDrawMesh> gOctoSphereWireSimpleMesh;
