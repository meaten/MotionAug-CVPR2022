...
public:
	...
	static void BuildOctoSphereMesh(int stacks, int slices, std::unique_ptr<cDrawMesh>& out_mesh);
	static void BuildSphereWireSimpleMesh(int stacks, int slices, std::unique_ptr<cDrawMesh>& out_mesh);
	static void BuildOctoSphereWireSimpleMesh(int stacks, int slices, std::unique_ptr<cDrawMesh>& out_mesh);
