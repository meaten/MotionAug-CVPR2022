...
public:
	...
	static void DrawInfoRewardLog(const cCircularBuffer<double>& rlog, const cCircularBuffer<double>& rlog_imitate, const cCircularBuffer<double>& rlog_goal, const cCamera& cam, const double origin_y);
protected:
