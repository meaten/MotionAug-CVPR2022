...
public:
	...
	static bool BuildController(const tCtrlParams& params, std::shared_ptr<cCtController>& out_ctrl);
	
protected:

	static bool BuildCtController(const tCtrlParams& params, std::shared_ptr<cCtController>& out_ctrl);
	static bool BuildCtPDController(const tCtrlParams& params, std::shared_ptr<cCtController>& out_ctrl);
	static bool BuildCtPDResController(const tCtrlParams& params, std::shared_ptr<cCtController>& out_ctrl);
	static bool BuildCtVelController(const tCtrlParams& params, std::shared_ptr<cCtController>& out_ctrl);
