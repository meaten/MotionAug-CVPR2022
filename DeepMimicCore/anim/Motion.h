...
public:
	...
	static const std::string gKeyFrameKey;
...
protected:
	...
	virtual void FabrikIK(Eigen::MatrixXd& mFrames, std::vector<tVector> GoalPos, std::vector<tVector> Center, std::vector<int> IKjoint, std::vector<double> PertitionTime, double WindowTime);
	virtual void Warp(Eigen::MatrixXd& out_frames, std::vector<tVector> Center, std::vector<tVector> GoalPos, std::vector<double> PertitionTime);
	virtual double TracePhase(double time_warped, std::vector<double> pertition_time, std::vector<double> pertition_time_warped);
	virtual int ChoosePertitionIdx(double time, std::vector<double> PertitionTime) const;
	virtual std::vector<double> EigenVec2Vec(Eigen::VectorXd vec);
};
